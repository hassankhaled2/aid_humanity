    ...
    return Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              if (pressedDel == true) {
                Navigator.of(context).pushNamedAndRemoveUntil(AppRouter.bottomNavigationDelivery, (route) => false);
              } else {
                Navigator.of(context).pushNamedAndRemoveUntil(AppRouter.bottomNavigationDonor, (route) => false);
              }
            },
